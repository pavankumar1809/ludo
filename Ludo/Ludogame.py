...
def windec():
    result = messagebox.askquestion('System', 'Are you sure you want to skip?', icon="warning")
    if result == 'yes':
        root.destroy()
        import windec
#------------------------------------------------------------------------------------------------------------------
...
def main():
    ...
    if c == 0:                              #constructs the game pieces first time the code is ran.
        ...
        if c >= 1:                                #This condition is true when a click is made.
            ...
            if BLUE == True and TURN == False:                        #same as REDS COD
                la="BLUE"
...
def turn():   #Prints whoose turn is it
    ...
    if RED == True:
        L2 = Label(root, text="   Red's Turn    ", fg='red', background='grey', font=("Arial", 24, "bold"))
        L2.place(x=770, y=50)

    if BLUE == True:
        L2 = Label(root, text="   Blue's Turn   ", fg='blue',background='grey', font=("Arial", 24, "bold"))
        L2.place(x=770, y=50)

    if GREEN == True:
        L2 = Label(root, text="Green's Turn  ", fg='green',background='grey', font=("Arial", 24, "bold"))
        L2.place(x=770, y=50)

    if YELLOW == True:
        L2 = Label(root, text="Yellow's Turn", fg='yellow',background='grey', font=("Arial", 24, "bold"))
        L2.place(x=770, y=50)
btnplay=Button(root,text="skip",width=7,bg='pink',font=('arial',9,'bold'),command=windec)
btnplay.place(x=1100,y=50)
